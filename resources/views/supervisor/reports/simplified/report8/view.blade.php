            ...
            <div class="card">
                <div class="card-header pb-0">
                    <h5 class="text-center alert alert-md alert-dark">
                        تقرير لمبيعات الموظف وسعر الجرام
                    </h5>
                </div>
                <div class="card-body p-1 m-1">
                    <form action="{{route('simplified.report8.post')}}" method="post"
                    ...
                    @if(isset($_POST['submit']))
                        <form action="{{route('simplified.report8.print')}}" method="post" class="d-inline">
                            @csrf
                            @method('POST')
