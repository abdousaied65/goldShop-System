        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body p-1 m-1">
                    <form action="{{route('declaration.report5.post')}}" method="post"
                    ...
                    @if(isset($_POST['submit']))
                        <form action="{{route('declaration.report5.print')}}" method="post" class="d-inline">
                            @csrf
                            @method('POST')
                    ...
                    @if(isset($_POST['submit']))
                        ...
                        <div class="results row mt-1 mb-3 p-3">
                            <table class="table table-condensed table-bordered text-center table-striped table-hover">
                                ...
                                <tbody>
                                <tr>
                                    <td class="tx-26">{{$sum_final_total}}</td>
