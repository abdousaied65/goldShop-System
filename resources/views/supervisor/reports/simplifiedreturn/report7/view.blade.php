        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body p-1 m-1">
                    <form action="{{route('simplifiedreturn.report7.post')}}" method="post"
                    ...
                    @if(isset($_POST['submit']))
                        <form action="{{route('simplifiedreturn.report7.print')}}" method="post" class="d-inline">
                            @csrf
                            @method('POST')
