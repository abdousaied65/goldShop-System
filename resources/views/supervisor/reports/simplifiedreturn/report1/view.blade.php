        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body p-1 m-1">
                    <form action="{{route('simplifiedreturn.report1.post')}}" method="post"
                    ...
                    @if(isset($_POST['submit']))
                        <form action="{{route('simplifiedreturn.report1.print')}}" method="post" class="d-inline">
                            @csrf
                            @method('POST')
                    ...
                    @if(isset($_POST['submit']))
                        ...
                        <div class="alert alert-md alert-danger text-center">
                            تقرير شامل المرتجعات ( الفواتير الضريبية المبسطة ) للفرع
                            ( {{$branch_name}} )
                            من يوم
                            {{$_POST['from_date']}}
                            الى يوم
