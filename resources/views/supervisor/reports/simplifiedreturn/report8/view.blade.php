            ...
            <div class="card">
                <div class="card-header pb-0">
                    <h5 class="text-center alert alert-md alert-dark">
                        تقرير لمرتجعات الموظف وسعر الجرام
                        ( الفواتير الضريبية المبسطة )
                    </h5>
                </div>
                <div class="card-body p-1 m-1">
                    <form action="{{route('simplifiedreturn.report8.post')}}" method="post"
                        ...
                        <div class="row m-t-3 mb-3">
                            ...
                            <div class="col-md-4">
                                <label> حد ادنى سعر الجرام <span class="text-danger">*</span></label>
                                <input class="form-control mg-b-20" dir="ltr"
                                       @if(isset($_POST['min_gram_price']))
                                       value="{{$_POST['min_gram_price']}}"
                                       @endif
                                       name="min_gram_price" required=""
                                       type="number">
                            </div>
                            <div class="col-md-4">
                                <label> حد اقصى سعر الجرام <span class="text-danger">*</span></label>
                                <input class="form-control mg-b-20" dir="ltr"
                                       @if(isset($_POST['max_gram_price']))
                                       value="{{$_POST['max_gram_price']}}"
                                       @endif
                                       name="max_gram_price" required=""
                                       type="number">
                            </div>
                            <div class="col-md-4">
                    ...
                    @if(isset($_POST['submit']))
                        <form action="{{route('simplifiedreturn.report8.print')}}" method="post" class="d-inline">
                            @csrf
                            @method('POST')
                            ...
                            <input type="hidden" name="min_gram_price" value="{{$_POST['min_gram_price']}}"/>
                            <input type="hidden" name="max_gram_price" value="{{$_POST['max_gram_price']}}"/>
