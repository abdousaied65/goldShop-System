        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body p-1 m-1">
                    <form action="{{route('simplifiedreturn.report4.post')}}" method="post"
                        ...
                        <div class="row m-t-3 mb-3">
                            ...
                            <div class="col-md-4">
                                <label> العيار <span class="text-danger">*</span></label>
                                <select required name="karat" class="form-control">
                                    <option
                                        @if(isset($_POST['karat']) && $_POST['karat'] == 18 )
                                        selected
                                        @endif
                                        value="18"> عيار 18
                                    </option>
                                    <option
                                        @if(isset($_POST['karat']) && $_POST['karat'] == 21 )
                                        selected
                                        @endif
                                        value="21"> عيار 21
                                    </option>
                                    <option
                                        @if(isset($_POST['karat']) && $_POST['karat'] == 24 )
                                        selected
                                        @endif
                                        value="24"> عيار 24
                                    </option>
                    ...
                    @if(isset($_POST['submit']))
                        <form action="{{route('simplifiedreturn.report4.print')}}" method="post" class="d-inline">
                            @csrf
                            @method('POST')
                            ...
                            <input type="hidden" name="karat" value="{{$_POST['karat']}}"/>
