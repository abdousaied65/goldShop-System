        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    @endif
                    <h5 class="alert alert-md alert-danger text-center">
                        تعديل فاتورة ضريبية للشركات والمؤسسات
                    ...
                    <form action="{{route('supervisor.tax.store')}}" method="POST">
                            ...
                            <div class="col-lg-6 pull-right">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" required type="text" name="company_name"
                                           id="company_name"
                                           @if(isset($open_invoice) && !empty($open_invoice))
                                           value="{{$open_invoice->company_name}}"
                                           @else
                                           value=""
                                        @endif
                                    />
                            ...
                            <div class="col-lg-6 pull-right">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" required
                                           minlength="15" id="company_tax_number"
                                           maxlength="15"
                                           type="text" dir="ltr" name="company_tax_number"
                                           @if(isset($open_invoice) && !empty($open_invoice))
                                           value="{{$open_invoice->company_tax_number}}"
                                           @else
                                           value=""
                                        @endif
                                    />
                        ...
                        @if(isset($open_invoice) && !empty($open_invoice))
                            <div class="row text-center">
                                <h5 class="w-100 alert alert-danger text-center">
                        ...
                        @endif
                        <input type="hidden" name="tax_id" id="tax_id" value={{$open_invoice->id}} />
                    </form>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#save').on('click', function () {
                ...
                let company_tax_number = $('#company_tax_number').val();
            ...
            $('#payment_method').on('change', function () {
                ...
                if (payment_method == "mixed") {
                    $('#save').attr('payment_method', payment_method);
                    $('#save').show();
                    $('#cash_amount').removeClass('d-none');
                    $('#visa_amount').removeClass('d-none');
                } else {
                    $('#save').attr('payment_method', payment_method);
                    $('#save').show();
                    $('#cash_amount').addClass('d-none');
                    $('#visa_amount').addClass('d-none');
                }
            });
        });
    </script>
