        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="row mt-1 mb-1 text-center justify-content-center align-content-center">
                    <form method="GET" action="{{route('print.selected.branches')}}">
                        <button type="submit" class="btn btn-md btn-warning m-1 print_selected">
                            <i class="fa fa-print"></i>
                            طباعة
                        </button>
                    </form>
                    <form method="POST" action="{{route('export.branches.excel')}}">
                        @csrf
                        @method('POST')
                    ...
                    <form method="POST" class="" id="myForm" action="{{route('remove.selected.branches')}}">
                        @csrf
                        @method('POST')
                    ...
                    <a href="{{route('supervisor.branches.create')}}" role="button" class="btn btn-md btn-info m-1">
        ...
        <div class="modal" id="modaldemo8">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="{{ route('supervisor.branches.destroy', 'test') }}" method="post">
                        {{ method_field('delete') }}
                        {{ csrf_field() }}
...
<script>
    $(document).ready(function () {
        ...
        $('.remove_selected').on('click', function (e) {
            e.preventDefault();
            let branches = [];
            $("input:checkbox[name*='branches']:checked").each(function () {
