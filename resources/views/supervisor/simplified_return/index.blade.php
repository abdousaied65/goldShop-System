        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header pb-0">
                    <div class="col-lg-12 margin-tb">
                        <h5 class="text-center alert alert-md alert-success w-100">
                            <a href="{{route('supervisor.simplified_return.index')}}" class="text-dark">
                ...
                <div class="row mt-1 mb-1 text-center justify-content-center align-content-center">
                    <a href="{{route('supervisor.simplified_return.create')}}" role="button" class="btn btn-md btn-info m-1">
                        ...
                        <table
                            ...
                            @foreach ($data as $key => $return)
                                <tr>
                                    ...
                                    <td>
                                        <a target="_blank" href="{{route('supervisor.simplified.print',$return->simplified->id)}}">
