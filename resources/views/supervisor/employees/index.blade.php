        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="row mt-1 mb-1 text-center justify-content-center align-content-center">
                    <form method="GET" action="{{route('print.selected.employees')}}">
                        <button type="submit" class="btn btn-md btn-warning m-1 print_selected">
                            <i class="fa fa-print"></i>
                            طباعة
                        </button>
                    </form>
                    <form method="POST" action="{{route('export.employees.excel')}}">
                        @csrf
                        @method('POST')
                    ...
                    <form method="POST" class="" id="myForm" action="{{route('remove.selected.employees')}}">
                        @csrf
                        @method('POST')
                    ...
                    <a href="{{route('supervisor.employees.create')}}" role="button" class="btn btn-md btn-info m-1">
                    ...
                    <div class="table-responsive hoverable-table">
                        <table class="display w-100  text-nowrap table-bordered" id="example-table"
                            ...
                            <tr>
                                ...
                                <th class="border-bottom-0 text-center">اسم الموظف</th>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                @endcan
                                                @can('حذف موظف')
                                                    <a class="dropdown-item delete_employee"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header text-center">
                        <h6 class="modal-title w-100" style="font-family: 'Almarai'; ">حذف موظف</h6>
...
<script>
    $(document).ready(function () {
        ...
        $('.delete_employee').on('click', function () {
            ...
            $('.modal-body #employee_name').val(employee_name);
        });
        ...
        $('#example-table tfoot tr th:nth-child(3)').html('<input class="form-control" type="text" placeholder="اسم الموظف" />');
