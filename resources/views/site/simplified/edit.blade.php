            ...
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <h5 class="alert alert-md alert-danger text-center">
                        تعديل فاتورة ضريبية مبسطة جديدة
                ...
                <div class="card-body">
                    <form action="{{route('simplified.store')}}" method="POST">
                        @csrf
                        @method('POST')
                        ...
                        @endif
                        <input type="hidden" name="simplified_id" id="simplified_id" value={{$open_invoice->id}} />
                    </form>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#cancel').on('click', function () {
                let simplified_id = $('#simplified_id').val();
                $.post("{{route('delete')}}", {
                    ...
                    if (cash_amount == "" || visa_amount == "") {
                        ...
                        if (total_amount != final_total) {
                            ...
                            $.post("{{route('update')}}", {
                                ...
                                location.href = '/print-simplified/' + simplified_id;
                            });
                        }
                    }
